...
| **v6_p50** (2026-07-29) | 35,814 (9,761) | **0.940** | 0.844 | 0.909 | 0.862 | **0.868** |
| **v6_p85** (2026-07-30) | 61,494 (15,323) | _TBD_ | | | | |
...
## Next
- v6_p85 result (train 85%) → fill the table.
- test-set eval (`golf_reviewed/test`, people: Yujin, Alex, Kun, Madhu, AJ) once labeled → the honest held-out number.
- retrain full `golf_ego_v6` at 100% train.
